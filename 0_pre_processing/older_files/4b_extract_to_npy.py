...
if __name__=='__main__':
    ...
    df=f_get_df()
    t2=time.time()
    df=df.head(90000) ### If using a subset of the data, use multiple of 3 
    ...
    np.save(save_location+'initial_idx_arr.npy',idx_arr)

    print("Setup time",t2-t1) 
    
    data_size=idx_arr.shape[0]
    batch_size=min(100,data_size)
