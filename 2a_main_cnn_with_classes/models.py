...
def f_define_model(config_dict,name='1'):
    ...
    ### Strides instead of pools
        ...
        model_par_dict={'conv_size_list':[26,26,26,26],'kernel_size':(3,3),'pool_size':(2,2), 'strides':[1,2,3,4], 'no_pool':True, 'learn_rate':0.001, 'outer_dropout':0.2,
        'inner_dropout':0.5,'dense_size':51,'final_activation':'sigmoid','double_conv':True}
    elif name=='5': # Striding 
        model_par_dict={'conv_size_list':[102,102,51,51],'kernel_size':(3,3),'pool_size':(2,2), 'strides':[1,2,3], 'no_pool':True, 'learn_rate':0.001, 'outer_dropout':0.2,
        'inner_dropout':None,'dense_size':51,'final_activation':'sigmoid','double_conv':True}
    elif name=='6': # Striding 
        model_par_dict={'conv_size_list':[51,51,51],'kernel_size':(3,3),'pool_size':(2,2), 'strides':[1,2,3], 'no_pool':True, 'learn_rate':0.001, 'outer_dropout':0.2,
        'inner_dropout':None,'dense_size':51,'final_activation':'sigmoid','double_conv':True}
